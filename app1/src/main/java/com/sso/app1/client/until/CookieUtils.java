package com.sso.app1.client.until;
...
public class CookieUtils {
    ...
    public static Cookie getCookie( HttpServletRequest request3,String name) {
        Cookie[] cookies = request3.getCookies();
        if (cookies == null || cookies.length < 1) {
            return null;
        }
        Cookie cookie = null;
    ...
    public static void setCookie(HttpServletResponse response3, String name, String value) {
        if (StringUtils.isEmpty(name)) {
            return;
        }
        if (null == value) {
